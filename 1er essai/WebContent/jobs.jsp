...
<body>
    ...
    <div class="job_listing_area plus_padding" id="job_listing1">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                                ...
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <%URL = URL + resultSet.getString("company_name");%>
                                            <h4><a href='<%=URL%>'><%=resultSet.getString("company_name") %></a></h4>
                                            <div class="links_locat d-flex align-items-center">
                                                <div class="location">
                                                    <p> <i class="fa fa-map-marker"></i> <%=resultSet.getString("company_address") %></p>
                                                </div>
                                                <div class="location">
                                                    <p> <i class="fa fa-clock-o"></i> <%=resultSet.getString("period") %></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="jobs_right">
                                        <div class="apply_now">
                                            ...
                                            <a href='<%=URL%>' class="boxed-btn3">Apply Now</a>
                                        </div>
                                        <div class="date">
